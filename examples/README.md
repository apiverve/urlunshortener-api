# URL Unshortener API - Examples

This folder contains example code for using the URL Unshortener API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/urlunshortener',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/urlunshortener");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/urlunshortener](https://docs.apiverve.com/ref/urlunshortener)
