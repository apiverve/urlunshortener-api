...
// Request contains the parameters for the URL Unshortener API.
//
// Parameters:
...
// ResponseData contains the data returned by the URL Unshortener API.
type ResponseData struct {
	Source string `json:"source"`
	Destination string `json:"destination"`
	Unshortened bool `json:"unshortened"`
