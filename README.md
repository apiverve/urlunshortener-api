...
```bash
curl -X POST "https://api.apiverve.com/v1/urlunshortener" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/urlunshortener](https://docs.apiverve.com/ref/urlunshortener)

---

## Use Cases

Common use cases for the URL Unshortener API:
