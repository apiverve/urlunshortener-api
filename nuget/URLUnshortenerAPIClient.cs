...
namespace APIVerve.API.URLUnshortener
{
    ...
    /// <summary>
    /// Client for the URLUnshortener API
    /// </summary>
    public class URLUnshortenerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/urlunshortener";
        ...
        {
            { "url", new ValidationRule { Type = "string", Required = true, Format = "url" } }
        };
        ...
        public URLUnshortenerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLUnshortenerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public URLUnshortenerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, URLUnshortenerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(URLUnshortenerQueryOptions options)
        {
        ...
        public ResponseObj Execute(URLUnshortenerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(URLUnshortenerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(URLUnshortenerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(URLUnshortenerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(URLUnshortenerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(URLUnshortenerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(URLUnshortenerQueryOptions options)
        {
