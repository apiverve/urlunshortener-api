...
```gradle
dependencies {
    implementation 'com.github.apiverve:urlunshortener-api:1.1.14'
}
```
...
```java
import com.apiverve.urlunshortener.URLUnshortenerAPIClient;
import com.apiverve.urlunshortener.APIResponse;
import com.apiverve.urlunshortener.APIException;

// Initialize the client
URLUnshortenerAPIClient client = new URLUnshortenerAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("url", "https://bit.ly/3k3j4");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/urlunshortener](https://docs.apiverve.com/ref/urlunshortener)
...
- **Documentation:** [https://docs.apiverve.com/ref/urlunshortener](https://docs.apiverve.com/ref/urlunshortener)
- **Issues:** [GitHub Issues](https://github.com/apiverve/urlunshortener-api/issues)
